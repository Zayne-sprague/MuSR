...

{
  ...
  class SimpleTree extends Emitter {
    ...
    file(node, parent = this.parent, before) {
      ...
      // parent = parent.querySelector('.tree_container');
      var container = parent.querySelector('.tree_container');
      if (!container){
        container = document.createElement('div')
        container.classList.add('tree_container')
        container.classList.add('files')
      }

      var wrapper = document.createElement('div')
      wrapper.classList.add('file_wrapper');
      ...
      this.append(container, parent, before);
      // this.append(a, parent, before);
    ...
    folder(node, parent = this.parent, before) {
      ...
      const summary_container = Object.assign(document.createElement('div'), {
        textContent: node.name
      });
      summary_container.classList.add('summary_container');
